...
enum WalletFeature {
    FEATURE_BASE = 61000, // the earliest version new wallets supports (only useful for getinfo's clientversion output)
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT1000IFMN = 4, // ONLY_NONDENOMINATED and not 1000 BASE at the same time
