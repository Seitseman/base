/* src/config/base-config.h.  Generated from base-config.h.in by configure.  */
/* src/config/base-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.base.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Base Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Base Core 3.3.1"
