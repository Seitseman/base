...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1533087625, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51551;
        bnProofOfWorkLimit = uint256S("0x00fffffffffffffffffffffffffffffffffffffffff01895627fe853128d685a");
        ...
        genesis.nTime = 1533090779;
        genesis.nBits = 504365040;
        genesis.nNonce = 1299840;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000002d7a8725ab11816a707622609913c2776a5a35b1a9ee9587ccaff600f97"));
        ...
        nStartMasternodePayments = genesis.nTime + 84400;
